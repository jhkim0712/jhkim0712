...
- **Embedded Software (Firmware) Development**
    ...
    - 펌웨어 업데이트: UART, OTA(Over-the-Air) 펌웨어 업데이트 구현

- **Radar Sensor Development**
    - Radar: Infineon Xensiv Radar (BGT24LTR24 등) 활용 경험
    - Signal processing: FMCW 레이더 신호처리 기본 이해
    - data analysis: C#, Python(NumPy, SciPy, Matplotlib) 기반 레이더 데이터 분석 및 시각화
 
- **GUI Development**
    - .NET 환경의 C#을 사용하며, MVVM 디자인 패턴을 선호
    - 주요 개발 경험: 펌웨어 다운로드 툴, 센서 디버깅 및 데이터 시각화 UI 등
